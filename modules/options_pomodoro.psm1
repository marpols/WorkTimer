function pomodoro-Options {
	...
	$updatePom.Add_Click({ 
		...
		Toast-Notification -msg "Pomodoro updated:`nShort Break: $($shorBreak.Value) minutes.`nLong Break: $($lockout.Value) minutes.`nNumber of Pomodoros: $($pomNum.Value)`nChanges will take effect on restart." -header "Work Timer Update"
	})
